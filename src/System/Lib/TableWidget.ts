...
export default function TableWidget(props: any) {
  ...
  return Widget(
    ...
    Widget(
      BodyRefProvider,
      {},
      Widget(SplitRefProvider, {}, Widget(Table, props)),
    ),
  );
}
...
function Table(props: any) {
  ...
  useEffect(() => {
    ...
    const checkIndeterminate =
      checkIndex.some(Boolean) && checkIndex.some((x: any) => !x);
          ...
          : Container({
              ...
              child: Row({
                ...
                children: [
                  ...
                  !isSelectOne
                    ? null
                    : Button("Edit Data", { icon: "edit", height: 35 }),
                  Space(10),
                  !isSelectOne
                    ? null
                    : Button("Delete Data", {
                ...
                children: [
                    ...
                    : Container({
                        ...
                        child: Center({
                          child: Checkbox({
                            ...
                            onClick: (e: any) => {
                              setCheckIndex(
                                checkIndex.map(() => e.target.checked),
                              );
                  ...
                  Expanded({
                    child: SingleChildScrollView({
                      ...
                      child: Row({
                        width: fields.reduce(
                          (acc: any, field: any) => acc + field.width,
                          0,
                        ),
