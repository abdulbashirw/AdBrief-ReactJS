        ...
        children: [
          Container({
            ...
            child: TextField({
              ...
              fullWidth: true,
              onChange: (e: any) =>
                handleErrorChange(index, "code", e.target.value),
            }),
          }),
          Expanded({
            padding: 5,
            child: TextField({
              ...
              fullWidth: true,
              onChange: (e: any) =>
                handleErrorChange(index, "message", e.target.value),
            }),
          }),
          Container({
            width: 70,
              ...
              children: [
                Container({
                  ...
                  child: Button("", {
                    ...
                    onClick: () => {
                      setErrorList(
                        errorList.filter((_: any, i: number) => i != index),
                      );
                    },
                  }),
                }),
              ...
              children: [
                ...
                Container({
                  ...
                  child: Button("Add Error", {
                    icon: "add",
                    onClick: () =>
                      setErrorList([...errorList, { code: "", message: "" }]),
                  }),
                }),
              ],
            }),
