...
const descItems = [
  {
    content: "Detail, Descriptive, Diagnostic, Perspective, Predictive...",
  },
  {
    content: "Maks 5 User",
  },
...
const descSubItems = [
  ...
  {
    contentSub: "Positioning",
  },
  {
    contentSub: "Predictive transaction",
  },
];

export default function ContentUltimate() {
  return Column({
    children: [
      SizedBox({
        padding: 12,
        child: Text("Ultimate", { size: 20, weight: "bold" }),
      }),
      SizedBox({
        paddingTop: 5,
        paddingLeft: 12,
