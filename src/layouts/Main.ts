          ...
          child: Rows({
            children: [
              Click({
                ...
                click: (e: any) => {
                  const menu = Menu(e, {
                    anchorPosition: { left: e.clientX - 5, top: e.clientY - 50 },
                    children: [
                      { label: 'New Chat', icon: 'forum', colorIcon: 'green' },
                      { label: 'Change Modal', icon: 'adb', colorIcon: 'blue' },
                      'divider',
                      { label: 'Reset Setting', icon: 'reset_tv', colorIcon: 'red' },
                    ].map((item: any) => {
                      if (item === 'divider') {
                      ...
                      return MenuItem({
                        ...
                        child: ListItemText({
                          child: Rows({
                            ...
                            children: [
                              item.icon
                                ? Container({ width: 30, child: Icon(item.icon, { color: item.colorIcon }) })
                                : SizedBox({ width: 30 }),
                              Text(item.label),
                              Expanded(),
                            ],
                      ...
                      child: Stack({
                        children: [
                          ...
                          Positioned({
                            top: 0,
                            left: 0,
                            child: CircularProgress({ size: 30, color: 'info' }),
                          }),
                        ],
                      }),
                    }),
